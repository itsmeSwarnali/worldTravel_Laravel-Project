    ...
    <div class="form">
        <div class="container">
            <div class="row">
                <div class="col"></div>
                <div class="col">
                <form class="px-3 py-3 " role = "form" action="<?php echo e(route('logCheck')); ?>" method="post" id="quickForm" encrypt="multipart/form-data">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/WorldTravel/resources/views/login.blade.php ENDPATH**/ ?>