...
<div class="full-row">
        <div class="row">
                <div class="owl-carousel owl-theme owl-places">
                    ...
                    @foreach($otherPlaces as $value)
                        <div class="item">
                            <a href="">
                                <div class="owl-img">
                                    <img class="mask" src="{{asset($value->Image)}}" width="35px"  height="40px"  alt="no img">
                                </div>

                                <div class="welcome wow zoomIn">
                                    <h1 class="text-center">Welcome To {{$value->countryName}}</h1>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="owl-carousel owl-theme owl-bd">
                ...
                @foreach($bdPlaces as $value)
                <div class="item">
                    <a href="">
                        <img src="{{asset($value->Image)}}" width="35px"  height="40px"  alt="no img">
                        <h5 class="mt-4">{{$value->placeName}}</h5>
                        <a href="#" class="btn btn_places">{{$value->Expense}} Taka</a>
                  ...
                  <div class="col-lg-4 col-sm-12 ">
                      <div class="box wow fadeInLeft">
                          ...
                          <!--img class="mask" src="frontAssets/img/france.jpg" alt=""> -->
                            <div class="d_place">
                              <h3 class="white">{{$value->countryName}}</h3>
                              <h5 class="white">{{$value->placeName}}</h5>
                              <a href="#" class="btn btn_places">{{$value->Expense}} $</a>
                            </div>
...
<div class="full-row pt-5 pb-5 booking-form" id="booking-form">
    <div class="container">
        ...
        <form role="form" action="{{route('bookingList')}}" class="main-form" method="post" id="quickForm" enctype="multipart/form-data">
            @csrf
            <div class="row">
                ...
                <div class="col-12 col-sm-6 py-2 wow fadeInRight" data-wow-delay="300ms">
                    <select name="user_des_inBD" id="departement" class="custom-select">
                        ...
                        @foreach ($bdPlaces as $value)
                        <option value="{{$value->placeName}}">{{$value->placeName}}</option>
                        @endforeach
                    </select>
                </div>
